# This is a lot of stuff I don't understand but also looks smart and copied from hlissner dotfiles.
# I can feel the pain required to create something like this every time a new use case comes up and would like to test it out
# High chance I'll never use 90% of these cases 
