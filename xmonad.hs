...
myFont :: String
myFont = "xft:Sauce Code Pro:regular:size=9:antialias=true:hinting=true"
...
myTabTheme = def { fontName            = myFont
                 ...
                 , inactiveBorderColor = "#D8DEE9"
                 , activeTextColor     = "#5E81AC"
...
main = do
    ...
    xmonad $ ewmh def
        ...
        , logHook = dynamicLogWithPP $ namedScratchpadFilterOutWorkspacePP $ xmobarPP
              ...
              , ppHidden = xmobarColor "#5E81AC" "" . wrap "*" "" . clickable -- Hidden workspaces
